...
* shift right unsigned
    ...
    DATA(lv_count) = io_memory->get_stack( )->pop_i32( )->get_signed( ) MOD 32.

    DATA(li_val) = io_memory->get_stack( )->pop_i32( ).
    ...
    ELSE.
      DO lv_count TIMES.
        lv_int = lv_int DIV 2.
      ENDDO.
      io_memory->get_stack( )->push( zcl_wasm_i32=>from_unsigned( lv_int ) ).
    ENDIF.
