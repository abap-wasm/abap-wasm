CLASS zcl_wasm_i64_rotl DEFINITION PUBLIC.
  PUBLIC SECTION.
...
CLASS zcl_wasm_i64_rotl IMPLEMENTATION.

  METHOD parse.
    IF gi_singleton IS INITIAL.
      gi_singleton = NEW zcl_wasm_i64_rotl( ).
    ENDIF.
  ...
  METHOD zif_wasm_instruction~execute.
    ...
    DATA(lv_bits) = io_memory->get_stack( )->stack_pop_i64( )->get_signed( ) MOD 64.
    lv_hex = io_memory->get_stack( )->stack_pop_i64( )->get_signed( ).
