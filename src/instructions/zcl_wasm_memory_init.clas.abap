...
* https://webassembly.github.io/spec/core/exec/instructions.html#xref-syntax-instructions-syntax-instr-memory-mathsf-memory-init-x
    ...
    DATA(lv_number) = io_memory->get_stack( )->stack_pop_i32( )->get_unsigned( ).
    DATA(lv_source) = io_memory->get_stack( )->stack_pop_i32( )->get_unsigned( ).
    DATA(lv_destination) = io_memory->get_stack( )->stack_pop_i32( )->get_unsigned( ).
