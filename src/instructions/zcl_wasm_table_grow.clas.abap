...
* https://webassembly.github.io/spec/core/exec/instructions.html#xref-syntax-instructions-syntax-instr-table-mathsf-table-grow-x
    ...
    DATA(lv_n) = io_memory->get_stack( )->stack_pop_i32( )->get_signed( ).
    DATA(lv_val) = io_memory->get_stack( )->stack_pop( ).
    ...
    io_memory->get_stack( )->stack_push( zcl_wasm_i32=>from_signed( lv_sz ) ).
  ENDMETHOD.
