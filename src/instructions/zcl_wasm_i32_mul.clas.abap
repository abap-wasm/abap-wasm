...
CLASS zcl_wasm_i32_mul IMPLEMENTATION.
  ...
  METHOD zif_wasm_instruction~execute.
    ...
    DATA(lo_val1) = io_memory->get_stack( )->stack_pop_i32( ).
    DATA(lo_val2) = io_memory->get_stack( )->stack_pop_i32( ).
...
* dont overflow, so convert to int8s
    ...
    io_memory->get_stack( )->stack_push( zcl_wasm_i32=>from_int8( lv_long1 ) ).
