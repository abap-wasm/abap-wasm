...
CLASS zcl_wasm_f64 IMPLEMENTATION.
  ...
  METHOD floor_value.
    ...
    DATA(lo_val) = CAST zcl_wasm_f64( io_memory->get_stack( )->pop( ) ).

    io_memory->get_stack( )->push( from_float( floor( lo_val->mv_value ) ) ).
  ...
  METHOD eq.
    ...
    DATA(lv_val1) = CAST zcl_wasm_f64( io_memory->get_stack( )->pop( ) )->mv_value.
    DATA(lv_val2) = CAST zcl_wasm_f64( io_memory->get_stack( )->pop( ) )->mv_value.
